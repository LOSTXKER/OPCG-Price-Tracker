...
- **Watchlist toolbar ต้อง "เฉพาะที่จำเป็น"** — เบสบอกของเยอะไป → ตัดเหลือ: ค้นหา(ยุบ) · เรียง · ตัวกรอง · มุมมอง · แก้ไข + จำนวน · ชุดการ์ดย้ายเข้า popup ตัวกรอง · ปุ่มช่วงเวลา desktop โชว์เฉพาะมุมมองกริด (มุมมองรายการมีคอลัมน์ 24H/7D/30D แล้ว)
