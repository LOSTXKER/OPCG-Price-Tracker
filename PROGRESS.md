...
1. **2.5 ที่เหลือ**: `IDENTITY-01/10` auth kit (4 หน้า) · `HONEY-03/07` · `SETS-04`/`DISCOVERY-10` · `ADMIN-02/06` AdminDataTable 8 หน้า · `COMMERCE-02/04/05/06` · `CONTENT-03` guide perf (query take + ISR, แยก PR)
