...
## NEXT
1. **เบสเปิดดูบนมือถือ**: `http://192.168.1.145:59283/proto/mobile-home` (Wi-Fi วงเดียวกัน, dev server ต้องรันอยู่ — หรือรัน `npm run dev` แล้วเปิด `/proto/mobile-home`) → ปุ่มลอยสลับ 5 แบบ "เดิม / กลาง 5 / 7+เทียบ / บน 2 แถว / บนยุบเอง" → เคาะแบบสุดท้าย (Nami แนะนำ "บนยุบเอง" — ได้ค้นหาเด่น + เลือกชุดครบ โดยไม่เสียจอถาวร)
