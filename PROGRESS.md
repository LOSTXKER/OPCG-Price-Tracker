...
## NEXT
1. **เบสเปิดดูบนมือถือ**: `http://192.168.1.145:59283/proto/mobile-home` (Wi-Fi วงเดียวกัน, dev server ต้องรันอยู่ — หรือรัน `npm run dev` แล้วเปิด `/proto/mobile-home`) → ปุ่มลอยสลับ 3 แบบ "เดิม / ค้นหากลาง / ครบ 6 ช่อง" → เคาะแถบล่าง (จุดตัดสิน: ค้นหากลางเป๊ะแต่ย้าย รายการโปรด เข้าพอร์ต vs ครบทุกช่องแต่ปุ่มเยื้อง+ช่องแน่น)
