...
-- CreateEnum
CREATE TYPE "PriceSource" AS ENUM ('YUYUTEI', 'EBAY_JP', 'MERCARI_JP', 'PORTFOLIO', 'MARKETPLACE', 'CARDMARKET', 'TCGPLAYER');

-- CreateEnum
CREATE TYPE "PriceType" AS ENUM ('SELL', 'BUY', 'SOLD', 'LISTING');
...
CREATE TABLE "CardPrice" (
    ...
    "source" "PriceSource" NOT NULL DEFAULT 'YUYUTEI',
    "type" "PriceType" NOT NULL DEFAULT 'SELL',
    "priceJpy" INTEGER,
...
-- CreateTable
CREATE TABLE "SetDropRate" (
    "id" SERIAL NOT NULL,
    "setId" INTEGER NOT NULL,
    "rarity" TEXT NOT NULL,
    "avgPerBox" DOUBLE PRECISION,
    "ratePerPack" DOUBLE PRECISION,

    CONSTRAINT "SetDropRate_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "User" (
    ...
    "honeyPoints" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "Card_baseCode_idx" ON "Card"("baseCode");
...
-- CreateIndex
CREATE INDEX "CardPrice_cardId_source_scrapedAt_idx" ON "CardPrice"("cardId", "source", "scrapedAt" DESC);

-- CreateIndex
CREATE INDEX "CardPrice_scrapedAt_idx" ON "CardPrice"("scrapedAt");

-- CreateIndex
CREATE INDEX "SourceMapping_cardId_idx" ON "SourceMapping"("cardId");

-- CreateIndex
CREATE UNIQUE INDEX "SourceMapping_source_sourceIdentifier_key" ON "SourceMapping"("source", "sourceIdentifier");

-- CreateIndex
CREATE INDEX "SetDropRate_setId_idx" ON "SetDropRate"("setId");

-- CreateIndex
CREATE UNIQUE INDEX "SetDropRate_setId_rarity_key" ON "SetDropRate"("setId", "rarity");
...
-- AddForeignKey
ALTER TABLE "SourceMapping" ADD CONSTRAINT "SourceMapping_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SetDropRate" ADD CONSTRAINT "SetDropRate_setId_fkey" FOREIGN KEY ("setId") REFERENCES "CardSet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
