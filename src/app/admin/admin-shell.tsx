...
function NavContent({
  ...
  return (
    <>
      ...
      {/* Bottom actions */}
      <div className={cn("space-y-1 border-t border-border/20 pt-3", collapsed && "flex flex-col items-center")}>
        <button
          type="button"
          onClick={onLogout}
...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh bg-background">
      ...
      <aside
        className={cn(
          "hidden shrink-0 flex-col border-r border-border/40 bg-muted/10 transition-[width] duration-200 md:flex",
      ...
      >
        <div className="sticky top-0 flex h-dvh flex-col p-2">
          ...
          {/* Theme + Collapse */}
          <div className={cn("space-y-1 border-t border-border/20 pt-2", collapsed && "flex flex-col items-center")}>
      ...
      <div className="flex flex-1 flex-col overflow-y-auto">
        {/* Mobile Header */}
        <header className="sticky top-0 z-40 flex items-center gap-3 border-b border-border/40 bg-background/95 px-4 py-3 backdrop-blur-sm md:hidden">
