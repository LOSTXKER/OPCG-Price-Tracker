    ...
    <Surface variant="panel" className="overflow-hidden">
      ...
      {rest.length > 0 && (
        <button
          ...
          className="flex w-full items-center justify-center gap-1 border-t border-border/40 px-5 py-2.5 text-meta transition-colors hover:bg-muted/30 hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        >
