...
const COPY: Record<Look, { name: string; summary: string; tradeoff: string }> = {
  ...
  warm: {
    ...
    tradeoff:
      "เงาทองบนพื้นครีมของโหมดสว่างจะจางกว่าเงารุ้ง — ต้องดูจริงว่าเห็นชัดพอไหม",
  },
  aurora: {
      ...
      <div className="relative">
        ...
        <span
          ...
          className={cn(
            ...
            busy ? "proto-pulse" : "opacity-70",
            look === "aurora"
              ? "bg-[conic-gradient(from_180deg,rgba(139,92,246,.55),rgba(56,189,248,.5),rgba(244,114,182,.5),rgba(139,92,246,.55))]"
              : "bg-[conic-gradient(from_180deg,rgba(233,185,112,.6),rgba(244,166,60,.5),rgba(115,83,62,.45),rgba(233,185,112,.6))]",
          )}
        />
