...
const NAV_OPTIONS = [
  ...
  },
  {
    ...
    label: "กลาง 5",
    ariaLabel:
      "แถบล่างแบบปุ่มค้นหากลาง 5 ช่อง รายการโปรดเป็นไอคอนหัวใจบน navbar",
  },
  {
...
> = {
  ...
  search: {
    name: "ค้นหากลาง — ปุ่มนูนกลางแถบ + หัวใจบน navbar",
    summary:
      "ปุ่มค้นหาทรงกลมนูนขึ้นกลางแถบล่างพอดีเป๊ะ กดถึงง่ายสุดด้วยนิ้วโป้ง ส่วน รายการโปรด ย้ายขึ้นเป็นไอคอนหัวใจบน navbar — เสียบเข้าช่องเดิมของปุ่มค้นหาที่ย้ายลงมา ความกว้างแถวบนเท่าเว็บปัจจุบันเป๊ะ และยังเข้าถึงได้หนึ่งแตะจากทุกหน้า",
    tradeoff:
      "ช่วงแรกคนอาจมองหา รายการโปรด ที่แถบล่างตามความเคยชิน และไอคอนหัวใจบน navbar ไม่มีป้ายชื่อกำกับเหมือนช่องในแถบล่าง",
  },
  searchCompare: {
