...
> = {
  d3: {
    name: "D3 · สามแถว — ชีพจรมีแถวของตัวเอง",
    summary:
      "แถบชีพจรกลับมาเป็นแถวบนสุดเต็มความกว้างเหมือนของจริง สายพานเลยได้ที่วิ่งเท่าเดิม ไม่มีใครมาบีบ · แถวกลางเป็นเรื่อง \"กำลังดูอะไร + หาอะไร\" (เกม › ชุด ซ้าย · ค้นหากับอัปเกรดขวา) · แถวล่างรวมของฉันทั้งหมดต่อกันเป็นแถวเดียว ตั้งแต่พอร์ตยาวไปจนถึงเมนูโปรไฟล์",
    tradeoff:
      "สูงกว่าแบบสองแถวที่ลองก่อนหน้า — แลกมาด้วยการที่สายพานอยู่ได้เต็มที่ และไม่ต้องซ่อนสถิติหรือชื่อชุดแม้บนจอแคบ · แถวกลางเหลือช่องว่างกลางแถวค่อนข้างกว้าง",
  },
  d2: {
...
const SHARED_NOTES = [
  "D3 มีสามแถว: ชีพจรบนสุดเต็มแถว · เกม › ชุด กับค้นหาแถวกลาง · โลโก้ เมนู และของฉันแถวล่าง",
  "ชีพจรมีแถวของตัวเอง สายพานเลยได้ที่วิ่งเต็มเท่าของจริง ไม่ต้องซ่อนสถิติหรือชื่อชุดเลย",
  "ของฉันทั้งหมด (พอร์ต · รายการโปรด · Honey · แชท · แจ้งเตือน · โปรไฟล์) ต่อกันเป็นแถวเดียวที่แถวล่าง",
  "D2 เก็บไว้เทียบ = แบบสองแถวที่ยุบชีพจรเข้าไปรวม ซึ่งทำให้สายพานโดนบีบเหลือ 105px",
  "ทุกปุ่มสูง 40px ขึ้นไป · ของฉันมีป้ายชื่อครบ · ปุ่มชุดมีรูปกล่อง",
...
/**
 * D3 — สามแถว (เบสอธิบายชัด 2026-08-29): แถบชีพจรต้องเป็นแถวของตัวเองบนสุด
 *
 *   [32] ชีพจรเต็มแถว — สายพานได้ที่วิ่งเท่าของจริง ไม่โดนใครบีบ
 *   [48] เกม › ชุด ................................ ค้นหา · อัปเกรด
 *   [56] โลโก้ · เมนู ......... พอร์ต · โปรด · Honey · แชท · แจ้งเตือน · โปรไฟล์
 *
 * แถวกลาง = "กำลังดูอะไร + หาอะไร" · แถวล่าง = ของฉันทั้งหมดต่อกันเป็นแถวเดียว
 */
function D3Navbar() {
  return (
    <div>
      <PulseStrip />
      <div className="hairline-b flex h-12 items-center gap-3 px-8">
        <GameSelect />
        <ChevronRight className="size-3 shrink-0 text-muted-foreground/60" aria-hidden />
        <SetDropdown width="w-56" />
        <div className="min-w-0 flex-1" />
  ...
  return (
    <main className="min-h-screen bg-background px-4 py-8 text-foreground sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1440px]">
        <h1 className="text-h1">D3 สามแถว — ชีพจรอยู่บนสุดของมันเอง</h1>
        <p className="mt-2 max-w-3xl text-body text-muted-foreground">
          ชีพจรกลับมาเป็นแถวบนสุดของตัวเองเต็มความกว้าง สายพานเลยได้ที่วิ่งเท่าของจริง
          ไม่ต้องซ่อนสถิติหรือชื่อชุดอีกแล้ว · แถวกลางเป็นเรื่องกำลังดูอะไรกับหาอะไร
          ส่วนแถวล่างรวมของฉันทั้งหมดไว้ต่อกันเป็นแถวเดียว
        </p>
