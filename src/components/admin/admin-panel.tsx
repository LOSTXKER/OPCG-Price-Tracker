...
export function AdminPanel({
  ...
  return (
    ...
    >
      {hasHeader && (
        <header className="flex flex-wrap items-start justify-between gap-3 border-b border-hair px-4 py-3 sm:px-5">
      ...
      {footer && (
        <footer className="border-t border-hair px-4 py-3 sm:px-5">
          {footer}
        </footer>
      )}
    </Surface>
