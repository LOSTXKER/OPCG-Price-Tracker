...
export function AdminSaveBar({
  ...
  return (
    <div
      aria-hidden={!dirty}
      className={cn(
        "pointer-events-none sticky inset-x-0 bottom-0 z-sticky mt-6 transition-all duration-[var(--dur-base)]",
        dirty
    ...
    >
      <Surface
        variant="outline"
        className={cn(
          "pointer-events-auto flex flex-wrap items-center justify-between gap-3 bg-card px-4 py-3 shadow-[var(--elev-raised)]",
          dirty ? "panel-accent" : "",
        )}
      >
