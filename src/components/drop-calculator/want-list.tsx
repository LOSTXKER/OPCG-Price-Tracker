...
export function WantList({
  ...
  return (
    <div className="space-y-4">
      {wantCards.length === 0 ? (
        <>
          <p className="text-eyebrow">{t(lang, "wantList")}</p>
        ...
        <>
          <div data-testid="drop-chance-summary">
          ...
          <div data-testid="drop-want-list" className="border-t border-hair pt-3">
            <div className="mb-1 flex items-center justify-between">
              <p className="text-eyebrow">
                {t(lang, "wantList")}
                <span className="ml-1 text-primary">({wantCards.length})</span>
              </p>
              <Button onClick={onClearAll} variant="ghost" size="xs">
                {t(lang, "clearAll")}
              </Button>
            </div>
            <ul className="-mx-1.5 max-h-[280px] space-y-0.5 overflow-y-auto">
          ...
          <dl className="space-y-1 border-t border-hair pt-3 text-xs">
