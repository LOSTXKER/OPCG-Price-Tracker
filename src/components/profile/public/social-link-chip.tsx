...
const CHIP_CLASS =
  "inline-flex items-center gap-1.5 rounded-full border border-hair bg-transparent px-2.5 py-1 text-micro text-muted-foreground transition hover:border-border hover:bg-muted/40 hover:text-foreground";
