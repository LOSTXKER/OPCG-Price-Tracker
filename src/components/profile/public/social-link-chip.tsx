...
const CHIP_CLASS =
  "inline-flex items-center gap-1 rounded-full bg-muted/70 px-2 py-0.5 text-[11px] font-medium text-foreground/80 transition hover:bg-muted hover:text-foreground";
...
export function SocialLinkChip({
  ...
  const inner = (
    <>
      <span className="text-[10px] font-extrabold tracking-tight">{link.badge}</span>
