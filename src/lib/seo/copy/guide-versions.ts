...
export const GUIDE_VERSIONS_META = {
  ...
  description:
    "การ์ดวันพีช (One Piece Card Game) ไม่มีฉบับภาษาไทย — สรุปว่าฉบับญี่ปุ่นกับอังกฤษต่างกันตรงไหน ใช้แข่งในไทยได้ทั้งคู่ไหม ผสมในเด็คเดียวกันได้หรือเปล่า และทำไมราคาบนเว็บอ้างอิงตลาดญี่ปุ่น",
} as const;
