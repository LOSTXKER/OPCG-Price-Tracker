...
export const SEO_PAGE_META = {
  pricing: {
    title: "แพ็กเกจ Meecard — เช็คราคาการ์ดวันพีซฟรี อัปเกรดเมื่อพร้อม",
    description:
      "เช็คราคาการ์ดวันพีช (One Piece Card Game) ได้ฟรีไม่จำกัด ทั้งราคากลางรายใบ กราฟย้อนหลัง และราคา PSA 10 — อัปเกรด Pro เมื่ออยากได้พอร์ตใหญ่ขึ้น แจ้งเตือนราคา และ Export CSV",
  },
  about: {
    title: "เกี่ยวกับ Meecard — เว็บเช็คราคาการ์ดวันพีซของคนไทย",
    description:
      "Meecard คือเว็บอิสระที่รวมราคากลางการ์ดวันพีช (OPTCG) จากตลาดญี่ปุ่น อัปเดตทุกวันและแปลงเป็นเงินบาท — อ่านว่าเราเก็บราคาจากแหล่งไหน อัปเดตบ่อยแค่ไหน และคิดราคาบาทอย่างไร",
  },
  contact: {
    title: "ติดต่อ Meecard — แจ้งราคาผิด เสนอแนะ เรื่องการ์ดวันพีซ",
    description:
      "ติดต่อทีม Meecard เว็บเช็คราคาการ์ดวันพีช — แจ้งราคาที่ไม่ตรง เสนอฟีเจอร์ รายงานบั๊ก หรือคุยเรื่องความร่วมมือ ตอบกลับทางอีเมลทุกฉบับ",
  },
  honey: {
    title: "Honey Meecard — สะสมแต้มฟรี แลกรางวัลการ์ดวันพีซ",
    description:
      "Honey คือแต้มสะสมฟรีของ Meecard เว็บเช็คราคาการ์ดวันพีช — เช็คอินและทำภารกิจประจำวันรับ Honey แล้วนำไปแลกบัตรผ่าน Pro หรือตั๋วลุ้นรางวัลประจำเดือน",
  },
  raffleWinners: {
    title: "ประกาศผู้ชนะรางวัลประจำเดือน — Meecard การ์ดวันพีซ",
    description:
      "คลังประกาศผู้ชนะรางวัลประจำเดือนของ Meecard เว็บเช็คราคาการ์ดวันพีช — ดูย้อนหลังได้ทุกเดือนว่าใครได้รางวัลอะไร เปิดเผยผลจับรางวัลทั้งหมดเพื่อความโปร่งใส",
  },
  blog: {
